...
Furthermore, we present strategies to determine the type of adaptation on basis of error prediction and smoothness estimation via the decay rate of coefficients of Fourier and Legendre series expansions. Both refinement and coarsening are considered.
