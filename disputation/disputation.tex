...
\maketitle
\input{addendum/ins}
\input{addendum/dimensionless}
\input{addendum/elliptic}
\input{addendum/artificial}
\input{addendum/p4est}

\subtitle{Details on algorithms}
\maketitle
\input{addendum/fem}
\input{addendum/coarsening}
\input{addendum/dofenumeration}
\input{addendum/datatransfer}
\input{addendum/hpdecision}

\subtitle{More results}
\maketitle
\input{addendum/error}
\input{addendum/loadbalancing}
\input{addendum/scaling}
