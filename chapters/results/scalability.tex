...
Thus, an even more favorable error to wall time performance of \hp- compared to \h-adaptive methods are conceivable than presented in Fig.~\ref{fig:errorwalltime} and described in Sec.~\ref{sec:errorvsperformance}.
