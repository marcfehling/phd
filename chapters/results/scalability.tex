...
We spot a major increase of the wall time attributed to the actual solution of the equation system.

After no higher order elements will be introduced, left of the indicated vertical line in Fig.~\todo{fig}, the properly sacles again.
...
It appears that our choice of the preconditioner is not well chosen. Although it was the best choice at our disposal at the time this dissertation was written, we may think about an alternative to this. Instead of \gls{amg} \todo{long}, we should take into account geometric multigrid methods. 
