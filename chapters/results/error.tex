...
\caption[Arrangement of finite elements after six iterations with the Legendre coefficient decay strategy.]{Arrangement of finite elements after six iterations with the Legendre coefficient decay strategy. The colours represent different polynomial degrees $p$ of the assigned Lagrangian elements $Q_p$.}
\label{fig:fedegrees}
\end{figure}
...
\begin{figure}
\centering
%\input{figures/results/errorworkloadlegend} \\
%\vspace{1em}
...
%\end{subfigure}
\caption{Double logarithmic representation of error performances of several adaptation strategies compared to their workload measured by the wall time.}
