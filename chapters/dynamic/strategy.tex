...
%On cells with an adaptation flag but no future finite element, \h-adaptation will be performed.
%If such a future finite element is defined on marked cells, \p-adaptation will be performed, while cells will be \h-adapted if none is specified.
