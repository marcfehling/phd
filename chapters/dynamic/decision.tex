...
Further, we will investigate whether the determination of Fourier coefficients via fast Fourier transformation (FFT) methods \todo{place citation} offers a more efficient and generally applicable alternative to the method of \textcite{bangerth2009} presented above.