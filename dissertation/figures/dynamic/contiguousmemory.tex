\begin{tikzpicture}[scale=0.7]
  % draw cells
  \draw[fill=Set1-B!80] (0,-0.5) rectangle ( 7,2);
  \draw[fill=Set1-E!80] (7,-0.5) rectangle (14,2);
  ...
  % draw callbacks
  % cell_1
  \draw[fill=Set1-A!80] (0,-0.25) rectangle (3,1.25);
  \draw[fill=Set1-C!70] (3,-0.25) rectangle (6,1.25);
  ...
  % cell_2
  \draw[fill=Set1-A!80] ( 7,-0.25) rectangle (10,1.25);
  \draw[fill=Set1-C!80] (10,-0.25) rectangle (13,1.25);
