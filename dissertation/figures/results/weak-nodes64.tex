...
% auxiliary lines
\begin{scope}
  \draw[green, very thick] ({axis cs:307200000,0}|-{rel axis cs:0,1}) -- ({axis cs:307200000,0}|-{rel axis cs:0,0});
  \draw[blue, very thick] ({axis cs:51625521,0}|-{rel axis cs:0,1}) -- ({axis cs:51625521,0}|-{rel axis cs:0,0});
\end{scope}
