...
\addplot[mark=x, color=black]table [y=H1 error, x=ndofs, col sep=comma,
%select coords between index={0}{5}
] {data/error/p.csv};
%\addlegendentry{\p};
...
\addplot[mark=*, index of colormap=2 of Set1] table [y=H1 error, x=ndofs, col sep=comma,
%select coords between index={0}{5}
] {data/error/hp-fourier.csv};
%\addlegendentry{\hp{}-Fourier};

\addplot[mark=triangle*, index of colormap=3 of Set1] table [y=H1 error, x=ndofs, col sep=comma,
%select coords between index={1}{6}
] {data/error/hp-prediction.csv};
%\addlegendentry{\hp{}-prediction};

\addplot[dashed, mark=square*, index of colormap=1 of Set1] table [y=H1 error, x=ndofs, col sep=comma,
%select coords between index={0}{5}
] {data/error/hp-legendre-naive.csv};
%\addlegendentry{\hp{}-Legendre naive};

\addplot[dashed, mark=*, index of colormap=2 of Set1] table [y=H1 error, x=ndofs, col sep=comma,
%select coords between index={0}{5}
] {data/error/hp-fourier-naive.csv};
%\addlegendentry{\hp{}-Fourier naive};

\addplot[dashed, mark=triangle*, index of colormap=3 of Set1] table [y=H1 error, x=ndofs, col sep=comma,
%select coords between index={1}{6}
