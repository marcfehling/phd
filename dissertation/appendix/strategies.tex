...
\begin{figure}
\centering
\input{figures/appendix/strategies/corner-2d-errors-h-05}
...
\begin{figure}
\centering
\input{figures/appendix/strategies/corner-2d-errors-p-05}
...
\begin{subfigure}{1\textwidth}
  \centering
  \input{figures/appendix/strategies/corner-2d-errors-hp-fourier-naive-05}
  \caption{Naive approach.}
\end{subfigure}
\begin{subfigure}{1\textwidth}
  \centering
  \input{figures/appendix/strategies/corner-2d-errors-hp-fourier-05}
...
\begin{subfigure}{1\textwidth}
  \centering
  \input{figures/appendix/strategies/corner-2d-errors-hp-legendre-naive-05}
  \caption{Naive approach.}
\end{subfigure}
\begin{subfigure}{1\textwidth}
  \centering
  \input{figures/appendix/strategies/corner-2d-errors-hp-legendre-05}
  \caption{Educated guess approach.}
\end{subfigure}
...
\begin{subfigure}{1\textwidth}
  \centering
  \input{figures/appendix/strategies/corner-2d-errors-hp-prediction-naive-05}
  \caption{Naive approach.}
\end{subfigure}
\begin{subfigure}{1\textwidth}
  \centering
  \input{figures/appendix/strategies/corner-2d-errors-hp-prediction-05}
  \caption{Educated guess approach.}
\end{subfigure}
